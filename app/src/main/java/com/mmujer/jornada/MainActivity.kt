...
class MainActivity : AppCompatActivity() {
    ...
    fun registrar(contexto: Context, nombreArchivo: String, cadena: String){
        ...
        if(!archivo.exists()) {
            ...
            Toast.makeText(this@MainActivity, "Contexto: $cadena}", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    fun construirObjetoDesdeLinea(linea: String): Registro {
        ...
        val l = Registro(provincia, municipio, distrito, sector, fecha, coordinador, editor, hogares, mujeresH, hombresH, comerciales, impactadasC, educativos, impactadasE, otros, impactadosO, talleres, mujeresT, hombresT,totalG)
        //Toast.makeText(this@MainActivity, "Contexto: $l}", Toast.LENGTH_SHORT).show()
        return l
    }
    ...
    fun limpiarArchivo(rutaArchivo: String) {
        try {
            ...
            if (archivo.exists()) {
                ...
                archivo.writeText("")
                println("Contenido del archivo limpiado con éxito.")
            } else {
        ...
        llamada.enqueue(object : Callback<Registro> {
            override fun onResponse(call: Call<Registro>, response: Response<Registro>) {
                ...
                if(response.isSuccessful) {
                    ...
                    Toast.makeText(this@MainActivity, "Los datos estan subiendo", Toast.LENGTH_SHORT).show()
                } else {
            ...
            override fun onFailure(call: Call<Registro>, t: Throwable) {
               // Toast.makeText(this@MainActivity, "Fallo: $t", Toast.LENGTH_SHORT).show()
            }
        })
    }
